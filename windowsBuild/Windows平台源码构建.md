...
- [msys2下载](https://repo.msys2.org/distrib/x86_64/)
- 修改源地址加速，进入目录C:\msys64\etc\pacman.d
	- 修改mirrorlist.mingw32文件添加
```
	Server = http://mirrors.ustc.edu.cn/msys2/mingw/i686/
```
	- 修改mirrorlist.mingw64文件添加
```
	Server = http://mirrors.ustc.edu.cn/msys2/mingw/x86_64/
```
	- 修改mirrorlist.msys文件添加
```
...
- 配置msys2(修改msys2_shell.cmd文件内容)
```
set MSYS2_PATH_TYPE=inherit
```

- 重命名C:\msys64\usr\bin\link.exe为C:\msys64\usr\bin\link.bak 避免和MSVC的link.exe冲突

- [下载yasm](https://yasm.tortall.net/Download.html)[下载2](https://github.com/cseri/yasm-1.3.0-win64?tab=readme-ov-file) 下载完成后改名yasm.exe放在c:\msys64\usr\bin\

- 通过VS2015x64x86兼容工具命令启动msys2
```
msys2_shell.cmd -mingw64
```

- 下载ffmpeg源代码[各版本下载](https://ffmpeg.org/releases/)
- 进入ffmpeg源码目录切换分支
```
git checkout tags/n4.3.1 -b n4.3.1
```
